...
class QuotesModel {
  ...
  async sendErrorCallback (fspiopSource, fspiopError, quoteId, headers, span, modifyHeaders = true) {
    ...
    try {
      ...
      const newHeaders = this.generateRequestHeaders(fromSwitchHeaders, true)
      if (modifyHeaders === true) {
        delete newHeaders['FSPIOP-Signature'] // The signature will be generated by the WSO2
      }
      this.writeLog('The new headers from the switch are:')
      this.writeLog(newHeaders)
