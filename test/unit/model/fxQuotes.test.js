...
describe('FxQuotesModel Tests -->', () => {
  ...
  describe('handleFxQuoteUpdate', () => {
    ...
    test('should handle fx quote update in persistent mode', async () => {
      ...
      expect(fxQuotesModel.forwardFxQuoteUpdate).toBeCalledWith(headers, updateRequest, updateRequest, span.getChild())
  ...
  describe('forwardFxQuoteUpdate', () => {
    test('should forward fx quote update', async () => {
      ...
      await expect(fxQuotesModel.forwardFxQuoteUpdate(headers, updateRequest, updateRequest, childSpan)).resolves.toBeUndefined()
      ...
      expect(httpRequest).toHaveBeenCalledWith({
        ...
        url: `${mockEndpoint}/fxQuotes/${updateRequest.conversionRequestId}`,
    ...
    test('should format error thrown and re-throw', async () => {
      ...
      await expect(fxQuotesModel.forwardFxQuoteUpdate(headers, updateRequest, updateRequest, childSpan))
